...
const subjectMeta = {
  math:        { icon:"📐", glow:"#A855F7" }, maths:       { icon:"📐", glow:"#A855F7" },
  mathematics: { icon:"📐", glow:"#A855F7" }, physics:     { icon:"⚡", glow:"#3B82F6" },
  chemistry:   { icon:"⚗️", glow:"#F59E0B" }, biology:     { icon:"🌿", glow:"#10B981" },
  english:     { icon:"✏️", glow:"#F59E0B" }, malayalam:   { icon:"🌴", glow:"#14B8A6" },
  hindi:       { icon:"🪔", glow:"#EF4444" }, history:     { icon:"🏛️", glow:"#6366F1" },
  geography:   { icon:"🌍", glow:"#06B6D4" }, science:     { icon:"🔬", glow:"#10B981" },
  computer:    { icon:"💻", glow:"#6366F1" }, economics:   { icon:"📊", glow:"#F59E0B" },
  commerce:    { icon:"💼", glow:"#EC4899" },
};
      ...
      <div className="root">
        <style>{`
          ...
          *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
          :root{--g1:rgba(255,255,255,0.06);--gb:rgba(255,255,255,0.11);--t1:rgba(255,255,255,0.95);--t2:rgba(255,255,255,0.52);--t3:rgba(255,255,255,0.26);--ac:#C084FC;--bg:#050510;}
          ...
          .sub-card{background:var(--g1);border:1px solid var(--gb);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:18px;padding:16px 18px;text-decoration:none;color:var(--t1);display:flex;align-items:center;gap:14px;transition:transform 0.2s cubic-bezier(0.34,1.56,0.64,1),border-color 0.2s,box-shadow 0.2s;-webkit-tap-highlight-color:transparent;position:relative;overflow:hidden;animation:cardIn 0.35s ease both;}
          .sub-card::before{content:'';position:absolute;left:0;top:0;bottom:0;width:3px;background:linear-gradient(180deg,var(--gc,#C084FC),transparent);opacity:0.7;border-radius:18px 0 0 18px;}
          ...
          .sub-icon{width:52px;height:52px;border-radius:15px;flex-shrink:0;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;font-size:27px;}
          .sub-info{flex:1;min-width:0;}
          .sub-name{font-family:'Syne',sans-serif;font-size:16px;font-weight:700;letter-spacing:-0.2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
          .sub-hint{font-size:12px;color:var(--t2);margin-top:3px;}
          .sub-arrow{margin-left:auto;width:34px;height:34px;flex-shrink:0;border-radius:10px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;font-size:18px;color:var(--t2);}

          .skel{background:linear-gradient(90deg,rgba(255,255,255,0.03) 25%,rgba(255,255,255,0.07) 50%,rgba(255,255,255,0.03) 75%);background-size:200% 100%;animation:shimmer 1.5s infinite;border-radius:18px;height:84px;border:1px solid var(--gb);}
